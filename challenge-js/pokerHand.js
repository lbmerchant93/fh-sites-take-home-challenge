class PokerHand {
  ...
  isStraight() {
    return this.handValues[4] - this.handValues[0] === 4 || this.handValues[4] - this.handValues[0] === 12;
  }
  ...
  // Method that checks if hand is One Pair, Two Pair, Three of a Kind, Four of a Kind, or Full House, and returns answer
  isDuplicates() {
